...
type (
	...
	ShortUrlMap struct {
		Id       int64          `db:"id"`        // ä¸»é®
		CreateAt time.Time      `db:"create_at"` // åå»ºæ¶é´
		CreateBy string         `db:"create_by"` // åå»ºè
		IsDel    int64          `db:"is_del"`    // æ¯å¦å é¤ï¼0æ­£å¸¸1å é¤
		Lurl     sql.NullString `db:"lurl"`      // é¿é¾æ¥
		Md5      sql.NullString `db:"md5"`       // é¿é¾æ¥MD5
		Surl     sql.NullString `db:"surl"`      // ç­é¾æ¥
	}
)
